...
@Component
public class LessonEventLog implements ConstantProperties, ParameterProperties {

	@Autowired
	private ClassRepository classRepository;

	private static final Logger LOGGER = LoggerFactory.getLogger(LessonEventLog.class);
	...
	private static final String SHELF_COURSE_LESSON = "shelf.course.unit.lesson";

	private static final String CLASS_COURSE_LESSON = "class.course.unit.lesson";

	public void deleteEventLogs(String courseId, String unitId, String lessonId, User user) {
		try {

package org.ednovo.gooru.cassandra.custom.entity;
 ...
 * encoded as strings.
 */
public class GooruDefaultEntityManager<T, K> implements EntityManager<T, K> {
	...
	public static class Builder<T, K> {
        ...
        public GooruDefaultEntityManager<T, K> build() {
			...
			// build object
			return new GooruDefaultEntityManager<T, K>(this);
		}
	}
	...
	private GooruDefaultEntityManager(Builder<T, K> builder) {
